  ...
  return (
    <div className="flex h-screen flex-col bg-white overflow-y-auto pb-20">
      ...
      <div className="flex-1 px-6 pt-6 space-y-4">
        ...
        <Card className="flex items-center justify-between p-4 bg-orange-50/50 border-[#FF976A]/20">
          <div>
            <div className="text-sm font-bold text-gray-900 mb-1">今日未批注饮食</div>
            <div className="text-[10px] text-gray-500">有 3 条新饮食记录待审核</div>
          </div>
          <div className="text-xl font-bold text-[#FF976A]">3</div>
        </Card>
